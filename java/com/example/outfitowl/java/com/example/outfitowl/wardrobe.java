...
public class wardrobe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new recyclerAdapter(recyclerImageData, this);
        ...
        if (userEmail != null) {
            getUsername(userEmail, new camera.OnUsernameRetrievedListener() {
                @Override
...
//                                    dataClass.setItemKey(dataSnapshot.getKey());
    ...
    private void getUsername(String email, camera.OnUsernameRetrievedListener listener) {
